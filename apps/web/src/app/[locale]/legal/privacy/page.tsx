        ...
        <Card className="p-8 md:p-12 space-y-12">
          ...
          <section className="space-y-4">
            <p className="leading-relaxed text-slate-600">
              We understand that online privacy is important to our users
              (&quot;You&quot; and &quot;Your&quot;), especially when conducting
              business. This statement governs our privacy policies
              (&quot;Privacy Policy&quot;) concerning those users
              (&quot;Visitors&quot;) who visit without transacting business and
              users (&quot;Authorized Customers&quot;) who register to transact
              business and make use of the various services
              (&quot;Service&quot;), operationally offered by The IDEA
              (&quot;Company&quot;, &quot;Ourselves&quot;, &quot;We&quot;,
              &quot;Our&quot;, and &quot;Us&quot;).
            </p>
            <p className="leading-relaxed text-slate-600">
              This page applies to information collected through both our online
              and offline funnels. It informs you of our policies regarding the
              collection, use, and disclosure of personal information and data
              we receive from users of our Service.
            </p>
          </section>
            ...
            <div className="pl-11 space-y-6">
              <div>
                ...
                <p className="text-slate-600 mb-2">
                  Personal Data refers to any information that identifies or can
                  be used to identify, contact, or locate the person to whom
                  such information pertains, including, but not limited to:
                </p>
                <ul className="list-disc pl-5 text-slate-600 space-y-1">
                  <li>Name, address, phone number, and email address.</li>
                  <li>
                    <strong>Identity Verification:</strong> For high-value
                    rentals (e.g., PS5 consoles), we may request a copy of your
                    National ID or Passport.
                  </li>
                  <li>
                    <strong>Delivery Coordinates:</strong> Exact location data
                    shared with our logistics partners for order fulfillment.
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-slate-600">
                  We do not store your sensitive financial information (such as
                  raw credit card numbers) on our servers. All financial
                  transactions are processed by secure, third-party payment
                  providers including{' '}
                  <strong>
                    Wayl, ZainCash, FIB (First Iraqi Bank), and Stripe
                  </strong>{' '}
              ...
              <div>
                ...
                <p className="text-slate-600">
                  We collect information your browser sends whenever you visit
                  our Service. This Usage Data may include your computer’s
          ...
          <section className="space-y-4">
            ...
            <div className="pl-11 text-slate-600 space-y-4">
              <p>
                ...
                activity on our Service and hold certain information. Examples
                of Cookies we use:
              </p>
              ...
              <p>
                ...
                Service Providers (such as Google Analytics) to monitor and
          ...
          <section className="space-y-4">
            ...
            <div className="pl-11">
              <p className="text-slate-600 mb-4">
                The IDEA uses the collected data for various purposes:
              </p>
            ...
            <div className="pl-11 text-slate-600">
              ...
              <div className="bg-slate-50 p-4 rounded-lg border border-slate-100">
                <p className="text-sm">
                  ...
                  website, we store the personal information they provide in
          ...
          <section className="space-y-4">
            ...
            <div className="pl-11 text-slate-600">
              ...
              <p className="mt-2">
                If you are located outside of Iraq and choose to provide
                information to us, please note that we transfer the data to
                <strong>
                  {' '}
                  Iraq (and secure servers in Frankfurt, Germany via Supabase)
                </strong>{' '}
                and process it there. By submitting your information, you agree
                to this transfer.
              </p>
            </div>
          </section>
          ...
          <section className="space-y-4">
            ...
            <div className="pl-11 text-slate-600">
              <p className="mb-2">
                The IDEA may disclose your Personal Data in the good faith
                belief that such action is necessary to:
              </p>
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  Comply with a legal obligation (e.g., Iraqi Law enforcement
                  request).
                </li>
                <li>Protect and defend the rights or property of The IDEA.</li>
                <li>
                  Prevent or investigate possible wrongdoings in connection with
                  the Service (e.g., Rental Theft).
                </li>
                <li>
          ...
          <section className="space-y-4">
            ...
            <div className="pl-11 text-slate-600">
              <p className="mb-4">
                This Privacy Policy and any disputes related to it shall be
                governed by and construed in accordance with the laws of the
                Republic of Iraq, specifically:
              </p>
              ...
              <p>
                You agree that any legal action or proceeding between The IDEA
                and you for any purpose concerning this Privacy Policy shall be
                brought exclusively in a court of competent jurisdiction sitting
                in <strong>Baghdad, Iraq</strong>.
              </p>
            </div>
          </section>
            ...
            <div className="pl-11 text-slate-600 space-y-6">
              ...
              <div>
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm">
                  ...
                  <li>
                    <strong>Right to Delete:</strong> You can request that we
                    delete your data.
                  </li>
                  <li>
                    <strong>Right to Opt-Out:</strong> The IDEA does{' '}
              ...
              <div className="mt-4 p-4 bg-blue-50 text-blue-800 rounded-lg text-sm">
                ...
                <a
                  href="mailto:privacy@theideaiq.com"
                  className="font-bold underline"
                >
                  privacy@theideaiq.com
                </a>
                .
              </div>
            </div>
          ...
          <section className="space-y-4">
            ...
            <div className="pl-11 text-slate-600">
              <p>
                ...
                identifiable information from anyone under the age of 13. If we
