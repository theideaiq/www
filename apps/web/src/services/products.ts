...
// biome-ignore lint/correctness/noUnusedImports: Needed for type definition
...
export interface Product {
  ...
  isVerified: boolean;
  description: string;
  // biome-ignore lint/suspicious/noExplicitAny: Product details structure is flexible
...
function mapDBProductToUI(item: DBProduct): Product {
  ...
  return {
    ...
    // biome-ignore lint/suspicious/noExplicitAny: Handling potentially unstructured JSON data from DB
