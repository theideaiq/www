...
export function SubscriptionCard({
  ...
  return (
    // biome-ignore lint/a11y/useKeyWithClickEvents: simple selection card
    // biome-ignore lint/a11y/noStaticElementInteractions: simple selection card
    <div
      onClick={onSelect}
      className={`
    ...
    >
      ...
      <div className="space-y-3">
        {plan.features.map((feature, idx) => (
          // biome-ignore lint/suspicious/noArrayIndexKey: features are static strings
