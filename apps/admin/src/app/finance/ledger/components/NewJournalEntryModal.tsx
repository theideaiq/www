...
export function NewJournalEntryModal({ accounts }: { accounts: ChartOfAccount[] }) {
    ...
    return (
        <>
            ...
            <Modal isOpen={isOpen} onClose={() => setIsOpen(false)} title="New Journal Entry">
                <form onSubmit={handleSubmit} className="space-y-4 py-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex justify-end gap-4 text-sm font-medium">
                            <span>Total Debit: {lines.reduce((s, l) => s + Number(l.debit), 0).toFixed(2)}</span>
                            <span>Total Credit: {lines.reduce((s, l) => s + Number(l.credit), 0).toFixed(2)}</span>
                        </div>
                    </div>
