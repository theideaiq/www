...
export function CreateCampaignForm({ segments }: { segments: MarketingSegment[] }) {
    ...
    const handleSend = async () => {
        if (!subject || !segmentId || !body) return toast.error('All fields are required');
        ...
        <Card className="p-8 max-w-2xl mx-auto space-y-6">
            ...
            <div className="space-y-4">
                ...
                <div className="pt-4 flex justify-end">
                    <Button onClick={handleSend} isLoading={isSending} className="w-full md:w-auto">
                        Send Now
                    </Button>
                </div>
            </div>
