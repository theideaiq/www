...
const accounts = [
  // ASSETS
  { code: '1000', name: 'Cash in Bank', type: 'asset', category: 'Current Assets' },
  { code: '1200', name: 'Inventory (Vinyls/Tech)', type: 'asset', category: 'Inventory' },

  // REVENUE
  { code: '4000', name: 'Music Sales', type: 'revenue', category: 'Sales' },
  { code: '4100', name: 'Tech/Hardware Sales', type: 'revenue', category: 'Sales' },
  { code: '4200', name: 'Rental Income', type: 'revenue', category: 'Rentals' },
  { code: '4300', name: 'Academy Subscriptions', type: 'revenue', category: 'Academy' },

  // COGS (Cost of Goods Sold)
  { code: '5000', name: 'COGS - Vinyls', type: 'expense', category: 'COGS' },
  { code: '5100', name: 'COGS - Hardware', type: 'expense', category: 'COGS' },
  { code: '5200', name: 'Shipping & Delivery', type: 'expense', category: 'COGS' },

  // EXPENSES (SG&A)
  { code: '6000', name: 'Payroll & Salaries', type: 'expense', category: 'Ops' },
  { code: '6100', name: 'Marketing & Ads', type: 'expense', category: 'Growth' },
  { code: '6200', name: 'Software Subscriptions', type: 'expense', category: 'Tech' },
  { code: '6300', name: 'Office Rent', type: 'expense', category: 'Ops' },
  { code: '6400', name: 'Legal & Professional', type: 'expense', category: 'Ops' }
];
